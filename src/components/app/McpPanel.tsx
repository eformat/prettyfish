        ...
        <div className="flex items-start justify-between gap-2 border-b px-3.5 py-2.5">
          <div className="space-y-0.5">
            ...
            <p className="text-[11px] text-muted-foreground">
              Point any AI agent at this tab via MCP.
            </p>
          </div>
          <button
            type="button"
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2.5">
                ...
                <div className="space-y-2">
                  {[
                    { n: '1', text: 'Start a session to get a unique MCP URL for this tab.' },
                    { n: '2', text: 'Add it to Claude Code, Cursor, or any MCP client in one command.' },
                    { n: '3', text: 'Ask your agent to draw diagrams. They appear here instantly.' },
                  ].map(({ n, text }) => (
                    <div key={n} className="flex gap-2.5 items-start">
                      <span className="flex-shrink-0 w-4 h-4 rounded-full bg-primary/10 text-primary text-[9px] font-bold flex items-center justify-center mt-0.5">{n}</span>
